...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/ruthvik_official')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/volt_movies"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/volt_movies"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/ruthvik_official')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Join Our Main Channel', url='https://t.me/volt_movies')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
